...
for fip in list_of_fips:
    ...
    try:
        if float(deaths_diff[1]) > 0.0:
            ...
            change_deaths_per_10000 = round(10000.0 * float(change_deaths) / float(population[fip]), 2)
        else:
            change_percent_deaths = 0
            change_deaths = 0
            change_deaths_per_10000 = 0.0
    except:
        change_percent_deaths = 0
        change_deaths = 0
        change_deaths_per_10000
...
# add change by population
    ...
    # add change by population
    try:
        weekly_deaths_per_10000 = round(10000. * float(deaths_diff[0]) / float(population[fip]),
                                  3)  # no info for this county for the desired date
    except:
        weekly_deaths_per_capita = 0.0
    location_date_record.append(weekly_deaths_per_10000)

    location_date_record.append(change_deaths)
    location_date_record.append(change_deaths_per_10000)



    dataframe_list.append(location_date_record)

    if len(location_date_record) != 24:
...
header.append("Weekly Deaths Per 10000")
header.append("Weekly Change in Deaths")
header.append("Weekly Change in Deaths Per 10000")
...
fig = px.choropleth(dfchange, geojson=counties, locations='FIPS', color="Current Week New Deaths", #'"quantized_color", #geojson=counties
                          ...
                          range_color=(0, 50),  # the scale is max'd I don't know how to say ">700" maybe use a discrete scale
                           scope="usa",
                          # labels = False,
                           labels={"FIPS":"Location Index","Current Week New Deaths":"Current Week New Deaths"},#"quantized_color":"Current Week New Cases"},

                           #locationmode="USA-states",
                           hover_name = "location",


                          hover_data =["New Deaths % Change","Current Week New Deaths","Last Week New Deaths","2 Weeks Ago New Deaths","3 Weeks Ago New Deaths"]
...
fig.update_layout(margin={"r":0,"t":25,"l":0,"b":0},
                  ...
                  title_text = "<b>New Covid Deaths this Week Ending "+ date_v + " by US County (Updated Daily)</b>",
...
fig.add_annotation(   y = .25, yref = 'paper', yanchor = 'bottom', x = .895, xref='paper',xanchor = 'center', showarrow = False,
                      text = "<a href='https://www.glutenfreeyouandme.com/covid/covid_county_weekly_per_capita_deaths.html'> Map New Weekly Deaths per 10000 people</a> "
                      )
...
fig.add_annotation(   y = .18, yref = 'paper', yanchor = 'bottom', x = .895, xref='paper',xanchor = 'center', showarrow = False,
                      text = "<a href='https://www.glutenfreeyouandme.com/covid/covid_county_weekly_change_per_1000_deaths.html'> Map Change in Weekly Deaths Per 10000</a> "
                      )
...
fig.add_annotation(   y = .11, yref = 'paper', yanchor = 'bottom', x = .895, xref='paper',xanchor = 'center', showarrow = False,
                      text = "<a href='https://www.glutenfreeyouandme.com/covid/covid_county_weekly_per_capita.html'> Map New Weekly Cases/1000</a> "
                      )
...
fig.add_annotation(   y = .04, yref = 'paper', yanchor = 'bottom', x = .895, xref='paper',xanchor = 'center', showarrow = False,
                      text = "<a href='https://www.glutenfreeyouandme.com/covid/covid_county_weekly_change_per_1000.html'> Map Change in Weekly Cases/1000</a> "
                    )
...
#fig.show()
fig.write_html("covid_county_weekly_deaths.html")
fig.write_html(str("./ArchivedMaps/covid_county_weekly_deaths")+date_str+ ".html")
...
fig = px.choropleth(dfchange, geojson=counties, locations='FIPS', color="Weekly Deaths Per 10000", #geojson=countiesCases Per Capita
                        ...
                        range_color=(0, 4),  # the scale is max'd I don't know how to say ">700" maybe use a discrete scale
                           scope="usa",
                          # labels = False,
                           labels={"FIPS":"Location Index","Weekly Deaths Per 10000":"Weekly Deaths Per 10000"},

                           #locationmode="USA-states",
                           hover_name = "location",


                          hover_data =["New Deaths % Change","Weekly Deaths Per 10000","Population","Current Week New Deaths","Last Week New Deaths","2 Weeks Ago New Deaths","3 Weeks Ago New Deaths"]
...
fig.update_layout(margin={"r":0,"t":25,"l":0,"b":0},
                  ...
                  title_text = "<b>New Covid Deaths Per 10000 People in County this Week Ending "+ date_v + " (Updated Daily)</b>",
       #           y = .9, yref = 'paper', yanchor = 'bottom', x = .5, xref='paper',xanchor = 'center',
...
fig.add_annotation(   y = .18, yref = 'paper', yanchor = 'bottom', x = .895, xref='paper',xanchor = 'center', showarrow = False,
                      text = "<a href='https://www.glutenfreeyouandme.com/covid/covid_county_weekly_change_per_10000_deaths.html'> Map Change in Weekly Deaths Per 10000</a> "
                      )
...
#fig.show()
fig.write_html("covid_county_weekly_per_capita_deaths.html")
fig.write_html(str("./ArchivedMaps/covid_county_weekly_per_capita_deaths")+date_str+ ".html")
# now create map for weekly change *******************************************************************************************
#df_used = dfchange[["FIPS","Quantized Per Capita","Weekly % Change","Cases Per 1000","Population","Current Week New Cases","Last Week New Cases","2 Weeks Ago New Cases","3 Weeks Ago New Cases"]]
fig = px.choropleth(dfchange, geojson=counties, locations='FIPS', color="Weekly Change in Deaths", #geojson=countiesCases Per Capita

                           color_continuous_scale="Picnic", #Rainbow",#Viridis",
                           #category_orders= {"Quantized Per Capita":capita_order_list},
                           #color_discrete_sequence = px.colors.sequential.Reds, #['#FFFFFF','#FFDFDF','#FFBFBF','#FF9F9F','#FFAFAF','#FF8F8F','#FF6F6f','#FF4F4f','#FF0000'],
                           range_color=(-50, 50),  # the scale is max'd I don't know how to say ">700" maybe use a discrete scale
                           scope="usa",
                          # labels = False,
                           labels={"FIPS":"Location Index","Weekly Change in Deaths":"Weekly Change in Deaths"},

                           #locationmode="USA-states",
                           hover_name = "location",


                          hover_data =["Weekly Change in Deaths","New Deaths % Change","Current Week New Deaths","Last Week New Deaths","2 Weeks Ago New Deaths","3 Weeks Ago New Deaths"]
...
fig.update_layout(margin={"r":0,"t":25,"l":0,"b":0},
                  ...
                  title_text = "<b>Weekly Change in New Covid Deaths for Week Ending "+ date_v + " (Update Daily)</b>",
       #           y = .9, yref = 'paper', yanchor = 'bottom', x = .5, xref='paper',xanchor = 'center',
...
#fig.show()
fig.write_html("covid_county_weekly_change_deaths.html")
fig.write_html(str("./ArchivedMaps/covid_county_weekly_change_deaths")+date_str+ ".html")
# now create map for weekly change per 1000  *******************************************************************************************
#df_used = dfchange[["FIPS","Quantized Per Capita","Weekly % Change","Cases Per 1000","Population","Current Week New Cases","Last Week New Cases","2 Weeks Ago New Cases","3 Weeks Ago New Cases"]]
fig = px.choropleth(dfchange, geojson=counties, locations='FIPS', color="Weekly Change in Deaths Per 10000", #geojson=countiesCases Per Capita

                           color_continuous_scale="Picnic", #Rainbow",#Viridis",
                           #category_orders= {"Quantized Per Capita":capita_order_list},
                           #color_discrete_sequence = px.colors.sequential.Reds, #['#FFFFFF','#FFDFDF','#FFBFBF','#FF9F9F','#FFAFAF','#FF8F8F','#FF6F6f','#FF4F4f','#FF0000'],
                           range_color=(-3, 3),  # the scale is max'd I don't know how to say ">700" maybe use a discrete scale
                           scope="usa",
                          # labels = False,
                           labels={"FIPS":"Location Index","Weekly Change in Deaths Per 10000":"Weekly Change in Deaths Per 10000"},

                           #locationmode="USA-states",
                           hover_name = "location",


                          hover_data =["Weekly Change in Deaths Per 10000","Population","New Deaths % Change","Current Week New Deaths","Last Week New Deaths","2 Weeks Ago New Deaths","3 Weeks Ago New Deaths"]
...
fig.update_layout(margin={"r":0,"t":25,"l":0,"b":0},
                  ...
                  title_text = "<b>Weekly Change in New Covid Deaths Per 10000 People in County for Week Ending "+ date_v + "</b>",
       #           y = .9, yref = 'paper', yanchor = 'bottom', x = .5, xref='paper',xanchor = 'center',
...
#fig.show()
fig.write_html(str("./ArchivedMaps/covid_county_weekly_change_per_10000_deaths")+date_str+ ".html")
fig.write_html("covid_county_weekly_change_per_10000_deaths.html")
#add google tags to all the files
AddGoogleTracking("covid_county_weekly_deaths.html")
AddGoogleTracking("covid_county_weekly_per_capita_deaths.html")
AddGoogleTracking("covid_county_weekly_change_deaths.html")
AddGoogleTracking("covid_county_weekly_change_per_10000_deaths.html")