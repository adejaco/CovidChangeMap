...
Period = 14  ##set averaging period in days
interval_days = []
for i in range(0,5):
...
fig = px.choropleth(dfchange, geojson=counties, locations='FIPS', color="New_Confirmed_Current", #geojson=counties

                           color_continuous_scale="Rainbow",#Viridis",
                           range_color=(0, 300),
                           scope="usa",
                          # labels = False,
                           labels={"FIPS":"Location Index","New_Confirmed_Current":"New Weekly Cases"},

                           #locationmode="USA-states",
                           hover_name = "location",


                          hover_data =["Change_Confirmed_%","New_Confirmed_Current-1","New_Confirmed_Current-2","New_Confirmed_Current-3"]

                          )
fig.update_layout(margin={"r":0,"t":25,"l":0,"b":0},

                  title_text = "2 Week Period confirmed cases "+ date_v +"; Hover shows % Change and 2 week cases back in time",
