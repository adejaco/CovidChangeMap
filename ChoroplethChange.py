...
for fip in list_of_fips:
    ...
    try:
        ...
        if float(confirmed_diff[1]) > 0.0:
            ...
            change_confirm_per_1000 = round(100.0*float(change_confirm)/float(population[fip]),2)
        else:
    ...
    for i in range(0,index_fip):
        location_date_record.append(str(' ' + str(deaths_diff[i])))
    if int(len(interval_days) - 1 - index_fip) != 0:
        for i in range(0, int(len(interval_days)-1 - index_fip)):
                location_date_record.append(0)
...
# add change by population
    ...
    if quantized_index >= divisions:
        ...
        quantized_per_capita = str(round(float(quantized_index * delta),3)) + " to " + str(round(float((quantized_index + 1) * delta),3))
...
fig = px.choropleth(dfchange, geojson=counties, locations='FIPS', color="quantized_color", #'"quantized_color", #geojson=counties
                          ...
                          # range_color=(0, 700),  # the scale is max'd I don't know how to say ">700" maybe use a discrete scale
                           scope="usa",
                          # labels = False,
                           labels={"FIPS":"Location Index","quantized_color":"Current Week New Cases"},#"quantized_color":"Current Week New Cases"},
...
fig.update_layout(margin={"r":0,"t":25,"l":0,"b":0},
                  ...
                  title_text = "<b>New Covid Cases this Week Ending "+ date_v + " by US County</b>",
...
fig.add_annotation(   y = .5, yref = 'paper', yanchor = 'bottom', x = 1.00, xref='paper',xanchor = 'center', showarrow = False,
...
fig.add_annotation(   y = .45, yref = 'paper', yanchor = 'bottom', x = 1.00, xref='paper',xanchor = 'center', showarrow = False,
                      text = "<a href='https://www.glutenfreeyouandme.com/covid/covid_county_weekly_per_capita.html'> Explore New Weekly Cases per 1000 people</a> "
                      )

fig.add_annotation(   y = .41, yref = 'paper', yanchor = 'bottom', x = 1.0, xref='paper',xanchor = 'center', showarrow = False,
                      text = "<a href='https://www.glutenfreeyouandme.com/covid/covid_county_weekly_change.html'> Explore Change in Weekly Cases</a> "
                      )
fig.add_annotation(   y = .37, yref = 'paper', yanchor = 'bottom', x = 1.00, xref='paper',xanchor = 'center', showarrow = False,
                      text = "<a href='https://www.glutenfreeyouandme.com/covid/covid_county_weekly_change_per_1000.html'> Explore Change in Weekly Cases Per 1000</a> "
                      )
fig.add_annotation(   y = .33, yref = 'paper', yanchor = 'bottom', x = 1.00, xref='paper',xanchor = 'center', showarrow = False,
...
fig = px.choropleth(dfchange, geojson=counties, locations='FIPS', color="Quantized Per Capita", #geojson=countiesCases Per Capita
                       ...
                       #    range_color=(0, 4),  # the scale is max'd I don't know how to say ">700" maybe use a discrete scale
                           scope="usa",
                          # labels = False,
                           labels={"FIPS":"Location Index","Quantized Per Capita":"Current Week New Cases Per 1000"},
...
fig.update_layout(margin={"r":0,"t":25,"l":0,"b":0},
                  ...
                  title_text = "<b>New Covid Cases Per 1000 this Week Ending "+ date_v + " by US County</b>",
       #           y = .9, yref = 'paper', yanchor = 'bottom', x = .5, xref='paper',xanchor = 'center',
...
fig.add_annotation(   y = .5, yref = 'paper', yanchor = 'bottom', x = 1.05, xref='paper',xanchor = 'center', showarrow = False,
                      text = "<b>Hover, Scroll, & Zoom on<br>Large Screen to Explore County Data</b>"
                            # Novel Coronavirus (COVID-19) Cases, provided by JHU CSSE "
                              #  <a href='https://github.com/CSSEGISandData/COVID-19'></a> "
                      )
fig.add_annotation(   y = .45, yref = 'paper', yanchor = 'bottom', x = 1.05, xref='paper',xanchor = 'center', showarrow = False,
                      text = "<a href='https://www.glutenfreeyouandme.com/covid/covid_county_weekly.html'> Explore New Weekly Cases</a> "
                      )
fig.add_annotation(   y = .41, yref = 'paper', yanchor = 'bottom', x = 1.05, xref='paper',xanchor = 'center', showarrow = False,
                      text = "<a href='https://www.glutenfreeyouandme.com/covid/covid_county_weekly_change.html'> Explore Change in Weekly Cases</a> "
                      )
fig.add_annotation(   y = .37, yref = 'paper', yanchor = 'bottom', x = 1.05, xref='paper',xanchor = 'center', showarrow = False,
                      text = "<a href='https://www.glutenfreeyouandme.com/covid/covid_county_weekly_change_per_1000.html'> Explore Change in Weekly Cases Per 1000</a> "
                      )

fig.add_annotation(   y = .33, yref = 'paper', yanchor = 'bottom', x = 1.05, xref='paper',xanchor = 'center', showarrow = False,
                      text = "Data Provided by <a href='https://github.com/CSSEGISandData/COVID-19'> JHU CSSE</a> "
                      )
#fig.show()
...
fig.update_layout(margin={"r":0,"t":25,"l":0,"b":0},
                  ...
                  title_text = "<b>Weekly Change in New Covid Cases for Week Ending "+ date_v + " by US County</b>",
       #           y = .9, yref = 'paper', yanchor = 'bottom', x = .5, xref='paper',xanchor = 'center',
...
fig.add_annotation(   y = .29, yref = 'paper', yanchor = 'bottom', x = .895, xref='paper',xanchor = 'center', showarrow = False,
                      text = "<b>Hover, Scroll, & Zoom on<br>Large Screen to Explore County Data</b>"
                            # Novel Coronavirus (COVID-19) Cases, provided by JHU CSSE "
                              #  <a href='https://github.com/CSSEGISandData/COVID-19'></a> "
                      )
...
fig.add_annotation(   y = .21, yref = 'paper', yanchor = 'bottom', x = .895, xref='paper',xanchor = 'center', showarrow = False,
                      text = "<a href='https://www.glutenfreeyouandme.com/covid/covid_county_weekly_per_capita.html'> Explore New Weekly Cases per 1000</a> "
                      )
fig.add_annotation(   y = .17, yref = 'paper', yanchor = 'bottom', x = .895, xref='paper',xanchor = 'center', showarrow = False,
                      text = "<a href='https://www.glutenfreeyouandme.com/covid/covid_county_weekly_change_per_1000.html'> Explore Change in Weekly Cases per 1000</a> "
                      )
fig.add_annotation(   y = .13, yref = 'paper', yanchor = 'bottom', x = .895, xref='paper',xanchor = 'center', showarrow = False,
                      text = "Data Provided by <a href='https://github.com/CSSEGISandData/COVID-19'> JHU CSSE</a> "
                      )
#fig.show()
...
fig = px.choropleth(dfchange, geojson=counties, locations='FIPS', color="Weekly Change in Confirmed Per 1000", #geojson=countiesCases Per Capita
                           ...
                           scope="usa",
                          # labels = False,
                           labels={"FIPS":"Location Index","Weekly Change in Confirmed Per 1000":"Weekly Change in Cases Per 1000"},

                           #locationmode="USA-states",
                           hover_name = "location",


                          hover_data =["Weekly Change in Confirmed Per 1000","Weekly % Change","Current Week New Cases","Last Week New Cases","2 Weeks Ago New Cases","3 Weeks Ago New Cases"]
...
fig.update_layout(margin={"r":0,"t":25,"l":0,"b":0},
                  ...
                  title_text = "<b>Weekly Change in New Covid Cases Per 1000 for Week Ending "+ date_v + " by US County</b>",
       #           y = .9, yref = 'paper', yanchor = 'bottom', x = .5, xref='paper',xanchor = 'center',
...
fig.add_annotation(   y = .17, yref = 'paper', yanchor = 'bottom', x = .895, xref='paper',xanchor = 'center', showarrow = False,
                      text = "<a href='https://www.glutenfreeyouandme.com/covid/covid_county_weekly_change.html'> Explore Change in Weekly Cases</a> "
#fig.add_annotation(y=.17, yref='paper', yanchor='bottom', x=.895, xref='paper', xanchor='center', showarrow=False,
#                   text="<a href='https://www.glutenfreeyouandme.com/covid/covid_county_weekly_change_per_1000.html'> Explore Change in Weekly Cases</a> "
#                   )
)
